...
<body>
    <div class="bg-gray-500 text-white h-[60px] flex items-center">
        <p class="mx-4">Admin Dashboard</p>
    </div>
    <div class="flex">
        <!-- component -->
        <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-[calc(100vh-2rem)] max-w-[20rem] shadow-xl shadow-blue-gray-900/5">
            <div class="mb-2 p-4">
                <h5 class="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-gray-900">Tech Thoughts</h5>
            </div>
            <nav class="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-gray-700">
                ...
                <a href="/admin/blogs">
                    ...
                    </div>Blog lists <div class="grid place-items-center ml-auto justify-self-end">
